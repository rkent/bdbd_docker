# investigation of different image embedding models

import tensorflow as tf
import tensorflow.keras as keras
import numpy as np
from sklearn.datasets import load_sample_image
from tensorflow.keras.applications.xception import preprocess_input, decode_predictions, Xception as Model
...
model = Model(weights="imagenet", include_top=False, pooling='max')
print(model.summary())
