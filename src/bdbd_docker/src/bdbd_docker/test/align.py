...
img1 = imgby2(cvBridge.compressed_imgmsg_to_cv2(img1_msg, desired_encoding='bgr8'))
img2 = imgby2(cvBridge.compressed_imgmsg_to_cv2(img2_msg, desired_encoding='passthrough'))
