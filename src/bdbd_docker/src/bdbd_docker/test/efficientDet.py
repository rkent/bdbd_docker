...
# alternate way to limit memory growth
'''
...
while True:
    ...
    if start_frame - start_sec > 1.0:
        print('fps: {} detect_time(ms): {:5.1f}'
            .format(frame_count, 1000. * sum_detect_sec / frame_count))
        frame_count = 0
    ...
    sum_detect_sec += time.time() - start_detect
